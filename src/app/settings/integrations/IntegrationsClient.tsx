    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm text-gray-900">Invite Finance Bot to Discord</h3>
                      <p className="text-xs text-gray-600">Add the bot to use /balance, /spending, /watchlist commands</p>
                    </div>
                  </div>
                  <a
                    href={botInviteUrl}
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#5865F2] text-white text-sm font-medium rounded-lg hover:bg-[#4752C4] transition-colors shadow-sm"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {discordConnection ? (
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="mt-4 pt-4 border-t border-blue-200">
                    <p className="text-xs text-gray-600">
                      Don&apos;t see your server? Use the <strong>&quot;Invite Bot&quot;</strong> button above to add the bot to your Discord server first.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-gray-900 mb-2">Connect Your Discord Account</h3>
                  <p className="text-gray-500 text-sm mb-4 max-w-md mx-auto">
                    Link your Discord account to receive financial notifications and use bot commands like /balance, /spending, and /watchlist.
                  </p>
                  
                  <div className="space-y-3">
                    <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                      <span className="w-5 h-5 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 font-medium">1</span>
                      <span>Invite the bot using the button above</span>
                    </div>
                    <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                      <span className="w-5 h-5 bg-[#5865F2] rounded-full flex items-center justify-center text-white font-medium">2</span>
                      <span>Connect your Discord account below</span>
                    </div>
                    <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                      <span className="w-5 h-5 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 font-medium">3</span>
                      <span>Link your server to enable commands</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Discord Notification Settings Link */}
          {discordConnection && guilds.length > 0 && (
            <Link href="/settings/notifications" className="block">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-300 hover:shadow-sm transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
