      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 rounded-xl border border-gray-200 p-6">
            ...
            <div className="flex items-center justify-between p-4 bg-white bg-zinc-800 rounded-lg">
              <div>
                <div className="font-medium text-sm">Theme</div>
                <div className="text-xs text-gray-500 text-zinc-400 mt-1">
                  Switch between light and dark mode
                </div>
              </div>
              <button
                onClick={toggleTheme}
                className="flex items-center gap-3 px-4 py-2 bg-gray-200 bg-zinc-700 rounded-lg hover:bg-gray-300 hover:bg-zinc-600 transition-colors"
              >
                {theme === "light" ? (
                  <>
